...
using PetapocoSimpleMembershipProvider.DAL.PetaPoco.DatabaseTypes;
using PetapocoSimpleMembershipProvider.DAL.PetaPoco.Internal;

namespace PetapocoSimpleMembershipProvider.DAL.PetaPoco
{
	/// <summary>
