...
namespace PetapocoSimpleMembershipProvider
{
    public class PetapocoSimpleMembershipProvider : ExtendedMembershipProvider
    {
        ...
        internal static int GetUserId(DatabaseWrapper db, string userTableName, string userNameColumn, string userIdColumn, string userName)
        {
        ...
        private static bool SetPassword(DatabaseWrapper db, int userId, string newPassword)
        {
        ...
        private static int GetPasswordFailuresSinceLastSuccess(DatabaseWrapper db, int userId)
        {
        ...
        private bool CheckPassword(DatabaseWrapper db, int userId, string password)
        {
        ...
        private string GetHashedPassword(DatabaseWrapper db, int userId)
        {
        ...
        private int VerifyUserNameHasConfirmedAccount(DatabaseWrapper db, string username, bool throwException)
        {
            int userId = GetUserId(db, SafeUserTableName, SafeUserNameColumn, SafeUserIdColumn, username);
            if (userId == -1)
            {
